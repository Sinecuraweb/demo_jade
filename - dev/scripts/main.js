var SliderWidget = ( function() {
    ...
    var _insertValues = function($this) {
        var
            ...
            from = container.find('.filer__slider-input_from'),
...
var ViewStateChange = (function () {
    ...
    var _changeState = function ($this) {
        var
            ...
            classOfViewsState = modificationPrefix + view;
        ...
        listOfItems.attr('class', _previousClass + '' + classOfViewsState);
    };
